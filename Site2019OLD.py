...
def makeTemplates(doc):
    ...
    Navigation(cssId='Navigation', parent=header)
    #MobileMenu(cssId='MobileMenu', parent=header)

    # Banner on full width
    Banner(cssId='Banner', parent=wrapper)
    
    # SlideShow https://www.bbslider.com
    group = Group(cssClass='slideshowgroup clearfix', parent=wrapper)
