...
slideshow = content.newSlideShow(h=300, slideW='100%', slideH=320, startIndex=3, autoHeight=True, carousel=2, dynamicHeight=False, transition='slide', easing=CSS_EASE, frameDuration=4, duration=0.7, pauseOnHit=True, randomPlay=False)
...
![IMG_6129.jpg w=800 x=center y=center](images/IMG_6129.jpg)
