...
~~~
---
## “ This was a very important foundation for me not only to further learning […] but also and more importantly rethink about my own design approach in a very fundamental way.”
...
from pagebot.constants import *
slideshow = content.newSlideShow(h=300, slideW='100%', slideH=300, startIndex=3, autoHeight=True, 
carousel=4, dynamicHeight=False, transition='slide', easing=CSS_EASE, frameDuration=4, duration=0.7, pauseOnHit=True, randomPlay=False)
box = slideshow.slides
~~~
...
This site is generated by [PageBot](https://GitHub.com/PageBot/PageBot/blob/master/README.md), generated from a single MarkDown file. Learning how that work can be the topic of a study.
