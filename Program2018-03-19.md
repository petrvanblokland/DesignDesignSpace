...
~~~
### The DesignDesign.Space program for 2018: Locations, dates and topics. Check for the available spaces left.
...
###<a href="#scripting-variable-font-specimens-for-type-designers-using-pagebot-tl">Variable Font specimens for type designers using PageBot (1 day)</a>
####April 15 (After Typolabs, on location, Berlin, 7 spaces left)

###<a href="#design-models">Design models (1 day)</a>
####April 24 (Online, 8 spaces left)

###<a href="#how-to-deal-with-customers">How to deal with customers? (1 day)</a>
####April 26 (Online, 8 spaces left) 

###<a href="#python-scripting-for-graphic-designers-online">Python scripting for graphic designers (4 weeks)</a>
#### May 7 - June 4 (Online, 7 spaces left)

###<a href="#rapid-prototyping-for-graphic-designers-at-typographics">Rapid prototyping for graphic designers (3 days)</a>
#### June 11-13 (On location during Typographics, New York) Subscribe by Typographics

###<a href="#typelab-at-typographics">TypeLab (3 days)</a>
#### June 14-16 (On location during Typographics, New York) Free for participants of Typographics

###<a href="#scripting-for-graphic-designers-at-typographics">Python scripting for graphic designers: public workshop (1 day)</a>
#### June 17 (On location during Typographics, Cooper Union, New York) Participation is free.

---

##<br/>What is it?
*DesignDesign.Space* is an online coaching environment to develop your design skills. Query your questions and improve your sketching. Acquire new techniques and research your way of presenting. In short, a space where you can design your design process. 
...
Find the planned program of studies and workshops below. <a href="mailto:info@designdesign.space?subject=Tell me more about DesignDesign.Space">Contact&nbsp;us</a> if you are interested.
...
|<a name="#robothon-design-design-space-party">Robothon DesignDesign.Space Party</a>|Mar&nbsp;8|Evening|Delft|Robothon| 
...
Special emphasis will be on the development of scripting for Variable Font design and proofing.

---
<a name="design-models"></a>
### Design models (1 day)
#### April 24 (Online, 8 spaces left) &#36;150 <a href="#how-to-reserve-and-pay">[Reserve&nbsp;here]</a>
...
#### April 26 (Online, 8 spaces left) &#36;150 <a href="#how-to-reserve-and-pay">[Reserve&nbsp;here]</a>
...
---
<a name="python-scripting-for-graphic-designers-online"></a>
### Python scripting for graphic designers (4 weeks)
#### May 7 - June 4 (Online, 7 spaces left) &#36;1.900 <a href="#how-to-reserve-and-pay">[Reserve&nbsp;here]</a>
...
---
<a name="rapid-prototyping-for-graphic-designers-at-typographics"></a>
### Rapid prototyping for graphic designers (3 days)
#### June 11-13 (On location during Typographics, New York) Subscribe by Typographics

This workshop offers an overview and the development of prototyping techniques for graphic designers, using a good mixture of physical sketching, standard digital tools and coding. Focus of the workshop is to give students enough options and directions to develop their prototyping skill further by themselves.

The tools used and created for the workshop are also very useful to support the design process of typographers and type designers.
...
* Various excercises of making prototypes, ranging from an initial brief to models of an exhibition.
* An overview of sketching techniques, physical and in code.
* Models to structure the design process: How does a “Quote” relate to a “Planning” and to the final presentation?
* Methods to seperate sketching from production, during the process of design.

---
<a name="typelab-at-typographics"></a>
### TypeLab (3 days)
#### June 14-16 (On location during Typographics, New York) Free for participants of Typographics
...
<a name="scripting-for-graphic-designers-at-typographics"></a>
### Python scripting for graphic designers: public workshop (1 day). 
#### June 17 (On location during Typographics, Cooper Union, New York) Participation is free.

During this one-day workshop, graphic designers learn from scratch how to script micro and macro tasks, during their design process. In a series of short specific assignments, if possible, closely related to their daily tasks, the designers learn to recognize design patterns that can be automated, breaking them down into existing functions and ones that need to be developed.

The study will address Python syntax, specifics of scripting for graphic design, planning, testing, brief usage of GIT, DrawBot, PageBot scripts and the specifics of output formats, such as documents for print and online usage. 

Experience with Pyton and DrawBot helps, but is not essential to appreciate the development of design-rules and algorhythms. Even for designers who don’t want to code, knowledge about patterns always helps to communicate with professional coders.  

####Take-aways

* Basic Python coding
* Basic thinking in design-rules, 
* Models for designing the design process
* Some directions for working with variable-fonts.
* Connecting to InDesign and HTML/CSS
* Examples Example templates as scripts for DrawBot and PageBot.
* Single-user/non-commercials licenses for some TYPETR fonts to work with during the workshop.

####See also the online version of this workshop as study of 4 weeks:
<a href="#python-scripting-for-graphic-designers-online">Python scripting for graphic designers</a> 

---

<a name="live-coaching-of-your-design-project"></a>
### Live coaching of your (type)design project 
#### Online, customized planning and topics. <a href="mailto:info@designdesign.space?subject=Tell me more about DesignDesign.Space">Ask for details on time and price.</a>
...
DesignDesign.Space offers the opportunity of live coaching. How this is organized, depends on your needs. It can be as one day of support while writing the quote, up to helping you with management and feedback of the entire project. All customized to what is required and available as budget.
...
DesignDesign.Space offers the opportunity of doing a virtual sabbatical: studying new topics or deepen the ones that you already know in a challenging online environment. Together with other students that are searching for the same kind of extension to their professional career. 
...
### After-ATYPI Special: Scripting Variable Font specimens for type designers using PageBot (1 day)
#### September 17 (On location Delft, 10 spaces left) &#36;150 <a href="#how-to-reserve-and-pay">[Reserve&nbsp;here]</a>
...
### Past event: Python scripting for type designers (4 weeks)
#### February 5 - March 5 2018 (Online, 6 spaces left) &#36;1.900 <a href="#how-to-reserve-and-pay">[Reserve&nbsp;here]</a>
...
### Past event: Python scripting for graphic designers
#### February 22 + March 14/15 + March 21/22 2018 (On location Den Bosch NL)
...
### Past event: Robothon | DesignDesign.Space Party 
#### March 8 2018 (On location, Delft. Free for all Robothon participants)
Traditional Robothon party in Delft, sponsored by DesignDesign.Space.

---
<a name="scripting-variable-fonts-specimens-for-type-designers-using-pagebot"></a>
### Past event: Scripting Variable Fonts specimens for type designers using PageBot 
#### March 8 2018 Lecture during Robothon (KABK, The Hague, NL)
...
### Past event: Python scripting for type designers (3 days)
#### March 10-12 2018 (Special Robothon edition, on location in Delft, 11 spaces left) &#36;450 <a href="#how-to-reserve-and-pay">[Reserve&nbsp;here]</a>
...
*What does your design profession look like 5 years from now? Or 20? Will your current skill set still be sufficient? How to make yourself independent from the changes in design that are likely to happen? Or better, how can you use them to your advantage?* Read what *DesignDesign.Space* has to offer.
