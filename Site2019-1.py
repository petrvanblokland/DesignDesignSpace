...
PAGES = (
    ...
    dict(href='2019-studies.html', label='2019 Studies', pages=(            
    ...
    dict(href='2018-reviews.html', label='2018 Reviews'),
...
def makeTemplates(doc):
    ...
    BareBonesSlideShow(cssId='SlideShow', parent=group, duration=0.7,
...
def makeSite(styles, viewId):
    ...
    doc = site.newDocument(viewId=viewId, autoPages=1)
