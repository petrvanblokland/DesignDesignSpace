...
siteDescription = [
    ('index', 'DDS Responsive Home'),
    #('content', 'PageBot Responsive Content'),
    ('page3', 'DDS Responsive Page 3'),
    ('page4', 'DDS Responsive Page 4'),
    ('page5', 'DDS Responsive Page 5'),
]
styles = dict(
    body=dict(
        fill=whiteColor,
...
def makeSite(siteDescription, styles, viewId):
    ...
    doc = site.newDocument(viewId=viewId, autoPages=len(siteDescription))
